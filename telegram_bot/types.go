...
// This object describes the source of a chat boost. It can be one of premium, gift_code, giveaway
// more info: https://core.telegram.org/bots/api#chatboostsource
type ChatBoostSource struct {
	// Source of the boost, can be premium, gift_code, giveaway
	Source string
	// optional if source=giveaway
	User *User `json:",omitempty"`
	// The number of Telegram Stars to be split between giveaway winners; for Telegram Star giveaways only
	//
	// optional, only for source=giveaway
